...
# Get the input language setting from the environmental variables.
...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "when", "where", "why", "who", "which", "whom", "whose", "can you", "what's", "where's", "how's", "can you"]
